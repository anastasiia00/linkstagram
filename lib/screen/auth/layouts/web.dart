...
class AuthWebLayout extends StatefulWidget {
  const AuthWebLayout({super.key});

  @override
  State<AuthWebLayout> createState() => _AuthWebLayoutState();
}

class _AuthWebLayoutState extends State<AuthWebLayout> {
